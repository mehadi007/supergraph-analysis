...
#python2.7 parse_graph.py EXAMPLES/fc_ch_st_nc_bc_nc.graph EXAMPLES/fc_ch_st_nc_bc_nc.model EXAMPLES > OUTPUT_fc_ch_st_nc_bc_nc_AUGMENTED.txt &

python2.7 parse_graph.py chocMediaWiki.sentenceEdges.graph chocMediaWiki.sentenceEdges_orderedALL.model EXAMPLES > OUTPUT_chocMediaWiki.sentenceEdges.txt &
