...
python2.7 parse_graph.py ../Graphs/lcrMediaWiki.sentenceEdges.graph ../models/slashburn_noNearStructs/lcrMediaWiki.sentenceEdges_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristicSelection_nStop_ALL_lcrMediaWiki.sentenceEdges_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristic_Selection_costs_ALL_lcrMediaWiki.sentenceEdges_orderedALL.model > OUTPUT_lcr_faster.txt &
...
##### ENRON
# Run faster heuristic (as in the conference paper)
python2.7 parse_graph.py ../Graphs/enron.graph ../models/slashburn_noNearStructs/enron_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristicSelection_nStop_ALL_enron_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristic_Selection_costs_ALL_enron_orderedALL.model > OUTPUT_enron_faster.txt &
...
##### EPINIONS
# Run faster heuristic (as in the conference paper)
python2.7 parse_graph.py ../Graphs/epinions_sym.graph ../models/slashburn_noNearStructs/epinions_sym_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristicSelection_nStop_ALL_epinions_sym_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristic_Selection_costs_ALL_epinions_sym_orderedALL.model > OUTPUT_epinions_sym_faster.txt &
...
##### EPINIONS
# Run faster heuristic (as in the conference paper)
python2.7 parse_graph.py ../Graphs/wwwbb_sym.graph ../models/slashburn_noNearStructs/wwwbb_sym_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristicSelection_nStop_ALL_wwwbb_sym_orderedALL.model ../MDL_methods/MDL_faster/NoNearStructs/heuristic_Selection_costs_ALL_wwwbb_sym_orderedALL.model > OUTPUT_wwwbb_sym_faster.txt &
...
##### BRAIN
python2.7 parse_graph.py ../Graphs/anonymized_processed_M87102217_fiber.graph ../models/slashburn_noNearStructs/anonymized_processed_M87102217_fiber_orderedALL.model ../MDL_methods/MDL_faster/heuristicSelection_nStop_ALL_anonymized_processed_M87102217_fiber_orderedALL.model ../MDL_methods/MDL_faster/heuristic_Selection_costs_ALL_anonymized_processed_M87102217_fiber_orderedALL.model > OUTPUT_M87102217_fiber_faster.txt &
